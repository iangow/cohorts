# Cohort Analysis -- `dbplyr` version
...
For example, if there were no `year()` or `age()` recognized by `dbplyr`, then 

:::

and join it to the time series.
...
df_fig_4_14 <-
  ...
  mutate(tenure = cut(cume_years, 
                      ...
                      labels = c("1 to 4", "5 to 10", "11 to 20",
                                 "21+"),
                      right = FALSE)) |>
